...
-- ----------------------------
BEGIN;
INSERT INTO `acl_groups` VALUES ('1', 'Invitado', '', 'Es el rango de los usuarios que todavía no se han logueado, no pueden hacer nada.'), ('2', 'Jugador', '', 'El rango del Jugador por defecto, es el rango normal que necesitas para poder loguearte en el juego.'), ('3', 'GM', '#8e208f', 'El rango de GM, tienen los permisos para poder acceder al Admin panel pero solo con las herramientas que necesitan para dar soporte, tickets, ...'), ('4', 'Moderador', '#00a3b6', 'Moderan el chat, los usuarios, ...'), ('5', 'QA', '#2a9553', 'A QA (= Departamento de Calidad) chequea la calidad en la web, en el juego y en los demás servicios, se encarga de reportar bugs a los programadores.'), ('6', 'Desarrollador', '#d56007', 'Un programador.'), ('7', 'Administrador', '#dc6200', 'El Administrador se encarga del staff.'), ('8', 'Propietario', '#ae1600', 'El propietario del servidor.');
COMMIT;
